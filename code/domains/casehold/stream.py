"""
CaseHOLD domain stream: 5-option legal case-holding MCQ.
"""
...
class CaseHOLDStream(DomainStream):
    ...
    def _precompute_features(self):
        ...
        for _, row in df.iterrows():
            ...
            q_len = float(row.get('question_length', 1000))
            feat_qlen = np.clip(q_len / 3000.0, 0, 1)
    ...
    def get_round(self, t: int) -> RoundData:
        ...
        return RoundData(
            ...
            metadata={'gold_answer': row.get('gold_answer', '')},
        )
